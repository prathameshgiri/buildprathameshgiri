export default function TechnologyStack() {
  const categories = [
    ...
    {
      name: "Backend",
      technologies: ["Node.js", "Express.js", "Python", "Django", "PHP", "REST APIs", "GraphQL"],
    },
    {
      name: "Database",
    ...
    },
    {
      ...
      technologies: ["Git", "Docker", "AWS", "Vercel", "Netlify", "GitHub", "CI/CD"],
    },
  ];
              ...
              <div className="space-y-3">
                {category.technologies.map((tech, techIdx) => (
                  <div
                    ...
                    style={{ animationFillMode: "forwards", animationDelay: `${0.4 + idx * 0.1 + techIdx * 0.05}s` }}
                  >
