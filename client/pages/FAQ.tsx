    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="relative w-full overflow-hidden bg-white flex-1">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 lg:py-32">
          <div className="text-center mb-12 opacity-0 animate-slide-up" style={{ animationFillMode: "forwards", animationDelay: "0.3s" }}>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          {faqs.map((categoryData) => (
            <div key={categoryData.category} className="mb-16">
              {/* Category Title */}
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-8 opacity-0 animate-slide-up" style={{ animationFillMode: "forwards", animationDelay: "0.2s" }}>
                ...
                {categoryData.questions.map((faq, idx) => {
                  ...
                  return (
                    <div
                      ...
                      style={{ animationFillMode: "forwards", animationDelay: `${0.3 + idx * 0.05}s` }}
                    >
                      <button
